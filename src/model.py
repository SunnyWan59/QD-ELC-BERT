...
class Embedding(nn.Module):
    def __init__(self, vocab_size, embedding_size):
        ...
        embedding_size: int
            should be d_model, the same dimension ass the positional encoder
        '''
        super(Embedding, self).__init__()
        self.embedding = nn.Embedding(vocab_size, embedding_size) # for now we will use pytorch's embedding layer
...
class PositionalEncoder(nn.Module):
    def __init__(self, 
        ...
        ---------
        model_dimension: int
            the dimension of the model, should be the same as the embedding dimension
        sequence_lenth: int
